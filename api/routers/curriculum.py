...
def get_niveles(service: CurriculumService = Depends(get_curriculum_service)):
    """
...
def get_oas(curso: str, asignatura: str, service: CurriculumService = Depends(get_curriculum_service)):
    """
